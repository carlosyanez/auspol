...
#> # A tibble: 344 × 17
#>     Year StateAb DivisionID DivisionNm PollingPlaceID PollingPlace Candi…¹ Surname GivenNm Ballo…² Elected Histo…³ PartyAb PartyNm Ordin…⁴ Swing Sitti…⁵
...
#> # … with 334 more rows, and abbreviated variable names ¹​CandidateID, ²​BallotPosition, ³​HistoricElected, ⁴​OrdinaryVotes, ⁵​SittingMemberFl
```
...
#>  9  2022 QLD            156 Brisbane             6017 Ascot          37204 KENNEDY Tiana         1 FALSE   FALSE   AJP     Animal…      35  1.65 FALSE  
#> 10  2022 QLD            156 Brisbane             6017 Ascot          35972 KNUDSON Justin…       2 FALSE   FALSE   UAPP    United…      62  2.06 FALSE  
#> # … with 702 more rows, and abbreviated variable names ¹​CandidateID, ²​BallotPosition, ³​HistoricElected, ⁴​OrdinaryVotes, ⁵​SittingMemberFl
```
...
#>  9  2022 QLD            156 Brisbane             6017 Ascot          37204 KENNEDY Tiana         1 FALSE   FALSE   AJP     Animal…      35  1.65 FALSE  
#> 10  2022 QLD            156 Brisbane             6017 Ascot          35972 KNUDSON Justin…       2 FALSE   FALSE   UAPP    United…      62  2.06 FALSE  
#> # … with 1,773 more rows, and abbreviated variable names ¹​CandidateID, ²​BallotPosition, ³​HistoricElected, ⁴​OrdinaryVotes, ⁵​SittingMemberFl
```
...
#> # A tibble: 12 × 17
#>     Year StateAb DivisionID DivisionNm PollingPlaceID PollingPl…¹ Candi…² Surname GivenNm Ballo…³ Elected Histo…⁴ PartyAb PartyNm Ordin…⁵  Swing Sitti…⁶
#>    <dbl> <chr>        <int> <chr>               <int> <chr>         <int> <chr>   <chr>     <int> <lgl>   <lgl>   <chr>   <chr>     <int>  <dbl> <lgl>  
#>  1  2022 WA             245 Perth                8203 Yokine Nor…   37417 BAILEY  Cameron       1 FALSE   FALSE   ON      Paulin…      25  -0.97 FALSE  
#>  2  2022 WA             245 Perth                8203 Yokine Nor…   36515 POWELL  Dean          2 FALSE   FALSE   AUC     Austra…      18   0.2  FALSE  
#>  3  2022 WA             245 Perth                8203 Yokine Nor…   37748 CONNOR  Sean          3 FALSE   FALSE   GAP     The Gr…      14   1.54 FALSE  
#>  4  2022 WA             245 Perth                8203 Yokine Nor…   37803 VOS     Dave          4 FALSE   FALSE   WAP     WESTER…      18  -0.19 FALSE  
#>  5  2022 WA             245 Perth                8203 Yokine Nor…   37233 SZMEKU… Sarah         5 FALSE   FALSE   AJP     Animal…      14   1.54 FALSE  
#>  6  2022 WA             245 Perth                8203 Yokine Nor…   37327 GORMAN  Patrick       6 TRUE    TRUE    ALP     Austra…     341   7.73 FALSE  
#>  7  2022 WA             245 Perth                8203 Yokine Nor…   37273 NICKOLS Evan          7 FALSE   FALSE   LDP     Libera…      18   1.98 FALSE  
#>  8  2022 WA             245 Perth                8203 Yokine Nor…   36507 EBERHA… Sonya …       8 FALSE   FALSE   UAPP    United…      23   1.21 FALSE  
#>  9  2022 WA             245 Perth                8203 Yokine Nor…   36628 PERKS   Caroli…       9 FALSE   FALSE   GRN     The Gr…     138   2.23 FALSE  
#> 10  2022 WA             245 Perth                8203 Yokine Nor…   36601 DWYER   David        10 FALSE   FALSE   LP      Liberal     298 -15.7  FALSE  
#> 11  2022 WA             245 Perth                8203 Yokine Nor…   37290 GYURU   Aiden        11 FALSE   FALSE   CYA     Austra…       4   0.44 FALSE  
#> 12  2022 WA             245 Perth                8203 Yokine Nor…     999 Inform… Inform…     999 FALSE   FALSE   Inform… Inform…      80   2.8  FALSE  
#> # … with abbreviated variable names ¹​PollingPlace, ²​CandidateID, ³​BallotPosition, ⁴​HistoricElected, ⁵​OrdinaryVotes, ⁶​SittingMemberFl
```
...
#>  2  2019 QLD            156 Brisbane         32751 PERRY     Anne                  1 FALSE   FALSE           ON       Pauline Hanson's … FALSE      1641
#>  3  2019 QLD            156 Brisbane         32946 NEWBURY   Paul                  6 FALSE   FALSE           ALP      Australian Labor … FALSE     19018
#>  4  2019 QLD            156 Brisbane         32960 WHITTAKER Aaron                 3 FALSE   FALSE           UAPP     United Australia … FALSE       975
#>  5  2019 QLD            156 Brisbane         33144 BARTLETT  Andrew                4 FALSE   FALSE           GRN      The Greens         FALSE     17247
#>  6  2019 QLD            156 Brisbane         33206 EVANS     Trevor                2 TRUE    TRUE            LNP      Liberal National … FALSE     36119
#>  7  2019 QLD            156 Brisbane         33224 EMANUEL   Kamala                7 FALSE   FALSE           SAL      Socialist Alliance FALSE       528
#>  8  2019 QLD            156 Brisbane         33326 JEANNERET Rod                   5 FALSE   FALSE           FACN     FRASER ANNING'S C… FALSE       526
...
#>  3  2019 TAS            192 Bass             32327 HART     Ross                    2 FALSE   TRUE            ALP      Australian Labor… FALSE     20882
#>  4  2019 TAS            192 Bass             32379 WOODBURY Susan                   3 FALSE   FALSE           AJP      Animal Justice P… FALSE      1422
...
#>  7  2019 TAS            192 Bass             32545 ROARK    Allan John              6 FALSE   FALSE           UAPP     United Australia… FALSE      2891
...
#> # … with 76 more rows, and abbreviated variable names ¹​SittingMemberFl, ²​OrdinaryVotes
```
...
#>    Year StateAb DivisionID DivisionNm CandidateID Surname    GivenNm   BallotPosition Elected HistoricElected PartyAb PartyNm            Sitti…¹ Ordin…²
#>   <dbl> <chr>        <int> <chr>            <int> <chr>      <chr>              <int> <lgl>   <lgl>           <chr>   <chr>              <lgl>     <int>
#> 1  2019 NT             306 Lingiari         32740 SNOWDON    Warren                 1 TRUE    TRUE            ALP     Australian Labor … FALSE     20125
#> 2  2019 NT             306 Lingiari         33045 PRICE      Jacinta                6 FALSE   FALSE           CLP     Country Liberals … FALSE     15918
#> 3  2019 NT             307 Solomon          32743 GOSLING    Luke John              1 TRUE    TRUE            ALP     Australian Labor … FALSE     19484
#> 4  2019 NT             307 Solomon          33053 GANLEY     Kathy                  3 FALSE   FALSE           CLP     Country Liberals … FALSE     18297
