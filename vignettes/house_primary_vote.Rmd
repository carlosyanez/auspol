...
#>  1  2022 QLD          156 Brisba…   83397 Alderl…   37204 KENNEDY Tiana         1 FALSE   FALSE   AJP     Animal…      23  2.31
#>  2  2022 QLD          156 Brisba…   83397 Alderl…   35972 KNUDSON Justin…       2 FALSE   FALSE   UAPP    United…      25  0.77
#>  3  2022 QLD          156 Brisba…   83397 Alderl…   37338 BATES   Stephen       3 TRUE    FALSE   GRN     Queens…     251  3.43
#>  4  2022 QLD          156 Brisba…   83397 Alderl…   37230 JARRETT Madonna       4 FALSE   FALSE   ALP     Austra…     315  1.27
#>  5  2022 QLD          156 Brisba…   83397 Alderl…   37482 EVANS   Trevor        5 FALSE   TRUE    LNP     Libera…     328 -9.97
#>  6  2022 QLD          156 Brisba…   83397 Alderl…   38213 HOLD    Trevor        6 FALSE   FALSE   ON      Paulin…      31  1.5 
#>  7  2022 QLD          156 Brisba…   83397 Alderl…   37311 BULL    Anthony       7 FALSE   FALSE   LDP     Libera…      22  2.21
#>  8  2022 QLD          156 Brisba…   83397 Alderl…     999 Inform… Inform…     999 FALSE   FALSE   Inform… Inform…      20 -1.17
#>  9  2022 QLD          156 Brisba…    6017 Ascot     37204 KENNEDY Tiana         1 FALSE   FALSE   AJP     Animal…      35  1.65
#> 10  2022 QLD          156 Brisba…    6017 Ascot     35972 KNUDSON Justin…       2 FALSE   FALSE   UAPP    United…      62  2.06
#> # … with 334 more rows, 1 more variable: SittingMemberFl <lgl>, and abbreviated variable names ¹​DivisionID, ²​DivisionNm,
...
#>  9  2022 QLD          156 Brisba…    6017 Ascot     37204 KENNEDY Tiana         1 FALSE   FALSE   AJP     Animal…      35  1.65
#> 10  2022 QLD          156 Brisba…    6017 Ascot     35972 KNUDSON Justin…       2 FALSE   FALSE   UAPP    United…      62  2.06
#> # … with 702 more rows, 1 more variable: SittingMemberFl <lgl>, and abbreviated variable names ¹​DivisionID, ²​DivisionNm,
#> #   ³​PollingPlaceID, ⁴​PollingPlace, ⁵​CandidateID, ⁶​BallotPosition, ⁷​HistoricElected, ⁸​OrdinaryVotes
```
...
#>  9  2022 QLD          156 Brisba…    6017 Ascot     37204 KENNEDY Tiana         1 FALSE   FALSE   AJP     Animal…      35  1.65
#> 10  2022 QLD          156 Brisba…    6017 Ascot     35972 KNUDSON Justin…       2 FALSE   FALSE   UAPP    United…      62  2.06
#> # … with 1,773 more rows, 1 more variable: SittingMemberFl <lgl>, and abbreviated variable names ¹​DivisionID, ²​DivisionNm,
#> #   ³​PollingPlaceID, ⁴​PollingPlace, ⁵​CandidateID, ⁶​BallotPosition, ⁷​HistoricElected, ⁸​OrdinaryVotes
```
...
#> # A tibble: 37 × 14
#>     Year StateAb DivisionID DivisionNm CandidateID Surname   GivenNm  BallotP…¹ Elected Histo…² PartyAb PartyNm Sitti…³ Ordin…⁴
...
#> # A tibble: 12 × 17
#>     Year StateAb Divis…¹ Divis…² Polli…³ Polli…⁴ Candi…⁵ Surname GivenNm Ballo…⁶ Elected Histo…⁷ PartyAb PartyNm Ordin…⁸  Swing
#>    <dbl> <chr>     <int> <chr>     <int> <chr>     <int> <chr>   <chr>     <int> <lgl>   <lgl>   <chr>   <chr>     <int>  <dbl>
...
#> # … with 76 more rows, and abbreviated variable names ¹​BallotPosition, ²​HistoricElected, ³​SittingMemberFl, ⁴​OrdinaryVotes
```
...
#> # … with abbreviated variable names ¹​BallotPosition, ²​HistoricElected, ³​SittingMemberFl, ⁴​OrdinaryVotes
```
...
#> # A tibble: 8 × 11
#>    Year StateAb DivisionNm PartyAb  PartyNm                              OrdinaryVotes GivenNm  Surname Perce…¹ Perce…² Elected
...
#> 4  2022 QLD     Brisbane   Informal Informal                                      1566 Informal Inform…    2.09    2.13 FALSE  
...
#> 8  2022 QLD     Brisbane   UAPP     United Australia Party                        1430 Justin … KNUDSON    1.91    1.95 FALSE  
...
#> # A tibble: 30 × 11
#>     Year StateAb DivisionNm  PartyAb PartyNm                OrdinaryVotes GivenNm Surname    Percentage_with_…¹ Perce…² Elected
#>    <dbl> <chr>   <chr>       <chr>   <chr>                          <int> <chr>   <chr>                   <dbl>   <dbl> <lgl>  
...
#> # … with 20 more rows, and abbreviated variable names ¹​Percentage_with_Informal, ²​Percentage
```
...
<img src="vignettes/house-primary-voteunnamed-chunk-11-1.png" alt="plot of chunk unnamed-chunk-11" width="100%" />
...
<img src="vignettes/house-primary-voteunnamed-chunk-12-1.png" alt="plot of chunk unnamed-chunk-12" width="100%" />
...
house_primary_historic_plot(division="Brisbane",parties=5,
                            merge_parties = list(LNP=c("LNP","LNQ","LP"),ON=c("HAN","ON"))) 
```

<img src="vignettes/house-primary-voteunnamed-chunk-13-1.png" alt="plot of chunk unnamed-chunk-13" width="100%" />
...
<img src="vignettes/house-primary-voteunnamed-chunk-14-1.png" alt="plot of chunk unnamed-chunk-14" width="100%" />
...
<img src="vignettes/house-primary-voteunnamed-chunk-15-1.png" alt="plot of chunk unnamed-chunk-15" width="100%" />
