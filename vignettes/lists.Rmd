...
#> # A tibble: 126 × 16
#>    State DivisionID DivisionNm PollingPlaceID PollingPlaceTypeID PremisesNm     Polli…¹ Latit…² Longi…³ `2004` `2007` `2010` `2013` `2016` `2019` `2022`
#>    <chr>      <int> <chr>               <int>              <int> <chr>          <chr>     <dbl>   <dbl> <lgl>  <lgl>  <lgl>  <lgl>  <lgl>  <lgl>  <lgl> 
#>  1 NSW          105 Bennelong              75                  1 Epping Boys H… Balacl…   -33.8    151. TRUE   TRUE   TRUE   TRUE   TRUE   TRUE   TRUE  
#>  2 NSW          105 Bennelong              75                  1 Epping Boys H… Marsfi…   -33.8    151. TRUE   TRUE   TRUE   TRUE   TRUE   TRUE   TRUE  
#>  3 NSW          105 Bennelong              79                  1 Australian Ai… Eastvi…   -33.8    151. TRUE   TRUE   TRUE   TRUE   TRUE   TRUE   NA    
#>  4 NSW          105 Bennelong              79                  1 Australian Ai… Ryde      -33.8    151. TRUE   TRUE   TRUE   TRUE   TRUE   TRUE   NA    
#>  5 NSW          105 Bennelong              79                  1 The Living Wa… Ryde      -33.8    151. NA     NA     NA     NA     NA     NA     TRUE  
#>  6 NSW          105 Bennelong              80                  1 Eastwood Heig… Eastwo…   -33.8    151. TRUE   TRUE   TRUE   TRUE   TRUE   TRUE   TRUE  
#>  7 NSW          105 Bennelong              81                  1 Epping Commun… Epping…   -33.8    151. TRUE   TRUE   TRUE   NA     NA     NA     NA    
#>  8 NSW          105 Bennelong              81                  1 Epping Public… Epping…   -33.8    151. NA     NA     NA     TRUE   TRUE   TRUE   TRUE  
#>  9 NSW          105 Bennelong              82                  1 Epping North … Epping…   -33.8    151. TRUE   TRUE   TRUE   TRUE   TRUE   TRUE   TRUE  
#> 10 NSW          105 Bennelong              84                  1 Gladesville P… Glades…   -33.8    151. TRUE   TRUE   TRUE   TRUE   TRUE   TRUE   TRUE  
