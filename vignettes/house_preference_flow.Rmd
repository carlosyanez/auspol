...
#>  5  2019 VIC            234 Wills             0              3       33251 KILLIN  Peter John        LP      Liberal Party of Australia… Prefer…   17241
#>  6  2019 VIC            234 Wills             0              3       33251 KILLIN  Peter John        LP      Liberal Party of Australia… Transf…       0
#>  7  2019 VIC            234 Wills             0              4       32657 PULFORD Adam Ross         GVIC    The Australian Greens - Vi… Prefer…   25575
#>  8  2019 VIC            234 Wills             0              4       32657 PULFORD Adam Ross         GVIC    The Australian Greens - Vi… Transf…       0
...
#>  1  2019 VIC            234 Wills          0 ABSENT        0              1       32688 MILES   Christopher Jam… AJP     Animal… N       Prefer…  254   
#>  2  2019 VIC            234 Wills          0 ABSENT        0              1       32688 MILES   Christopher Jam… AJP     Animal… N       Prefer…    4.65
#>  3  2019 VIC            234 Wills          0 ABSENT        0              1       32688 MILES   Christopher Jam… AJP     Animal… N       Transf…    0   
#>  4  2019 VIC            234 Wills          0 ABSENT        0              1       32688 MILES   Christopher Jam… AJP     Animal… N       Transf…    0   
#>  5  2019 VIC            234 Wills          0 ABSENT        0              2       32398 BOLTON  Susanne Alison   VNS     Victor… N       Prefer…  238   
#>  6  2019 VIC            234 Wills          0 ABSENT        0              2       32398 BOLTON  Susanne Alison   VNS     Victor… N       Prefer…    4.35
#>  7  2019 VIC            234 Wills          0 ABSENT        0              2       32398 BOLTON  Susanne Alison   VNS     Victor… N       Transf…    0   
#>  8  2019 VIC            234 Wills          0 ABSENT        0              2       32398 BOLTON  Susanne Alison   VNS     Victor… N       Transf…    0   
#>  9  2019 VIC            234 Wills          0 ABSENT        0              3       33251 KILLIN  Peter John       LP      Libera… N       Prefer…  862   
#> 10  2019 VIC            234 Wills          0 ABSENT        0              3       33251 KILLIN  Peter John       LP      Libera… N       Prefer…   15.8 
...
#> 1  2019 VIC            234 Wills             0              6       32350 KHALIL  Peter             ALP     Australian La…   42355       0       1 FALSE
#> 2  2019 VIC            234 Wills             0              4       32657 PULFORD Adam Ross         GVIC    The Australia…   25575       0       2 FALSE
#> 3  2019 VIC            234 Wills             0              3       33251 KILLIN  Peter John        LP      Liberal Party…   17241       0       3 FALSE
#> 4  2019 VIC            234 Wills             0              2       32398 BOLTON  Susanne Alison    VNS     Victorian Soc…    4344       0       4 FALSE
#> 5  2019 VIC            234 Wills             0              1       32688 MILES   Christopher James AJP     Animal Justic…    3596       0       5 FALSE
#> 6  2019 VIC            234 Wills             0              5       32329 VENKAT  Manju             UAPP    United Austra…    2979       0       6 TRUE 
...
#>    Year StateAb DivisionId DivisionNm CountNum BallotPosition CandidateId Surname GivenNm           PartyAb PartyNm        Prefe…¹ Trans…² Round…³ Last 
#>   <dbl> <chr>        <int> <chr>         <int>          <int>       <int> <chr>   <chr>             <chr>   <chr>            <dbl>   <dbl>   <int> <lgl>
#> 1  2019 VIC            234 Wills             1              6       32350 KHALIL  Peter             ALP     Australian La…   43301     946       1 FALSE
#> 2  2019 VIC            234 Wills             1              4       32657 PULFORD Adam Ross         GVIC    The Australia…   25811     236       2 FALSE
#> 3  2019 VIC            234 Wills             1              3       33251 KILLIN  Peter John        LP      Liberal Party…   18521    1280       3 FALSE
#> 4  2019 VIC            234 Wills             1              2       32398 BOLTON  Susanne Alison    VNS     Victorian Soc…    4511     167       4 FALSE
#> 5  2019 VIC            234 Wills             1              1       32688 MILES   Christopher James AJP     Animal Justic…    3946     350       5 TRUE 
#> # … with abbreviated variable names ¹​`Preference Count`, ²​`Transfer Count`, ³​RoundPosition
#> 
#> $`Round 2`
#> # A tibble: 4 × 15
#>    Year StateAb DivisionId DivisionNm CountNum BallotPosition CandidateId Surname GivenNm        PartyAb PartyNm           Prefe…¹ Trans…² Round…³ Last 
#>   <dbl> <chr>        <int> <chr>         <int>          <int>       <int> <chr>   <chr>          <chr>   <chr>               <dbl>   <dbl>   <int> <lgl>
#> 1  2019 VIC            234 Wills             2              6       32350 KHALIL  Peter          ALP     Australian Labor…   43982     681       1 FALSE
#> 2  2019 VIC            234 Wills             2              4       32657 PULFORD Adam Ross      GVIC    The Australian G…   27083    1272       2 FALSE
#> 3  2019 VIC            234 Wills             2              3       33251 KILLIN  Peter John     LP      Liberal Party of…   19108     587       3 FALSE
#> 4  2019 VIC            234 Wills             2              2       32398 BOLTON  Susanne Alison VNS     Victorian Social…    5917    1406       4 TRUE 
#> # … with abbreviated variable names ¹​`Preference Count`, ²​`Transfer Count`, ³​RoundPosition
#> 
#> $`Round 3`
#> # A tibble: 3 × 15
#>    Year StateAb DivisionId DivisionNm CountNum BallotPosition CandidateId Surname GivenNm    PartyAb PartyNm               Prefe…¹ Trans…² Round…³ Last 
#>   <dbl> <chr>        <int> <chr>         <int>          <int>       <int> <chr>   <chr>      <chr>   <chr>                   <dbl>   <dbl>   <int> <lgl>
#> 1  2019 VIC            234 Wills             3              6       32350 KHALIL  Peter      ALP     Australian Labor Par…   45442    1460       1 FALSE
#> 2  2019 VIC            234 Wills             3              4       32657 PULFORD Adam Ross  GVIC    The Australian Green…   30254    3171       2 FALSE
#> 3  2019 VIC            234 Wills             3              3       33251 KILLIN  Peter John LP      Liberal Party of Aus…   20394    1286       3 TRUE 
#> # … with abbreviated variable names ¹​`Preference Count`, ²​`Transfer Count`, ³​RoundPosition
#> 
#> $`Round 4`
#> # A tibble: 2 × 15
...
#>   <dbl> <chr>        <int> <chr>         <int>          <int>       <int> <chr>   <chr>     <chr>   <chr>                  <dbl>   <dbl>   <int> <lgl>  
#> 1  2019 VIC            234 Wills             4              6       32350 KHALIL  Peter     ALP     Australian Labor Pa…   55898   10456       1 TRUE   
#> 2  2019 VIC            234 Wills             4              4       32657 PULFORD Adam Ross GVIC    The Australian Gree…   40192    9938       2 FALSE  
#> # … with abbreviated variable names ¹​`Preference Count`, ²​`Transfer Count`, ³​RoundPosition
```
...
#>    Year StateAb DivisionId DivisionNm CountNum BallotPosition CandidateId Surname     GivenNm       PartyAb PartyNm        Prefe…¹ Trans…² Round…³ Last 
#>   <dbl> <chr>        <int> <chr>         <int>          <int>       <int> <chr>       <chr>         <chr>   <chr>            <dbl>   <dbl>   <int> <lgl>
#> 1  2022 NSW            151 Warringah         0              6       36808 MICKLEBURGH David Edward  ALP     Australian La…    7806       0       1 FALSE
#> 2  2022 NSW            151 Warringah         0              4       36675 GLANVILLE   Kristyn Maree GRN     The Greens NSW    6910       0       2 FALSE
#> 3  2022 NSW            151 Warringah         0              3       36271 ROBERTSON   Andrew Colin  UAPP    United Austra…    2202       0       3 FALSE
#> 4  2022 NSW            151 Warringah         0              1       37516 TRIPP       Steven Leslie ON      Pauline Hanso…    1980       0       4 FALSE
#> 5  2022 NSW            151 Warringah         0              7       36396 PATERSON    Kate Anne     AJP     Animal Justic…    1475       0       5 TRUE 
#> # … with abbreviated variable names ¹​`Preference Count`, ²​`Transfer Count`, ³​RoundPosition
```
