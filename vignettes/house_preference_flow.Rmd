...
#> $`Round 0`
#> # A tibble: 6 × 15
#>    Year StateAb DivisionId DivisionNm CountNum BallotPosition Candida…¹ Surname GivenNm PartyAb PartyNm Prefe…² Trans…³ Round…⁴ Last 
...
#> $`Round 4`
#> # A tibble: 2 × 15
#>    Year StateAb DivisionId DivisionNm CountNum BallotPosition Candi…¹ Surname GivenNm PartyAb PartyNm Prefe…² Trans…³ Round…⁴ Elected
#>   <dbl> <chr>        <int> <chr>         <int>          <int>   <int> <chr>   <chr>   <chr>   <chr>     <dbl>   <dbl>   <int> <lgl>  
